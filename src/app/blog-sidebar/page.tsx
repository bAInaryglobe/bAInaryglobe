...
export const metadata: Metadata = {
  ...
  description: "This is Blog Details Page for bAInaryglobe",
  // other metadata
};
          ...
          <div className="flex flex-wrap">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h1 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                  10 amazing projects from bAInaryglobe
                </h1>
                ...
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                   ...
                   Experience the novelty and uniqueness of software design.
            ...
            <div className="w-full px-4 lg:w-4/12">
              <aside className="space-y-8">
                {/* Search Box */}
                <div className="shadow rounded bg-white dark:bg-gray-dark p-6">
                  <div className="flex items-center">
                    <input
                      type="text"
                      placeholder="Search..."
                    ...
                    />
                    <button className="p-2 bg-primary text-white rounded-r">Go</button>
                  </div>
                </div>
                {/* Related Posts */}
                <div className="shadow rounded bg-white dark:bg-gray-dark">
                  <h3 className="border-b p-4 text-lg font-semibold">Related Posts</h3>
                  <ul className="p-4">
                ...
                {/* Popular Tags */}
                <div className="shadow rounded bg-white dark:bg-gray-dark p-4">
                  <h3 className="border-b text-lg font-semibold mb-4">Popular Tags</h3>
                  <div className="flex flex-wrap gap-2">
                    <TagButton text="Themes" />
                    <TagButton text="UI Kit" />
                    <TagButton text="Tailwind" />
                    <TagButton text="bAInaryglobe" />
