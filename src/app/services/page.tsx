...
const services = [
  {
    ...
    name: "Vexeroo",
    description:
      "Your comprehensive lifestyle platform that brings everything you need in one place.",
    category: "Platform",
    featured: true,
  },
  {
    ...
    name: "Vexeroo Car",
    description:
      "Premium automotive solutions integrated with smart technology for modern transportation.",
    category: "Automotive",
    featured: false,
  },
  {
    ...
    name: "VxFit",
    description:
      "A fitness app designed for busy office individuals to maintain healthy lifestyles.",
  ...
  },
  {
    ...
    name: "See Naija",
    description:
      "Discover Nigeria's tourism attractions right within the Vexeroo ecosystem.",
  ...
  },
  {
    ...
    name: "VxReels",
    description:
      "View engaging reels, live sessions of product unveilings, and much more.",
  ...
  },
  {
    ...
    name: "VxFuel",
    description:
      "Order fuel from the comfort of your home - no hassle, no sweat.",
  ...
  },
  {
    ...
    name: "VxCars",
    description:
      "Rent a car as easy as it gets - seamless, reliable, hassle-free.",
  ...
  },
  {
    ...
    name: "VxAI",
    description:
      "Chat with a fully customizable AI assistant for your daily activities.",
  ...
  },
  {
    ...
    name: "VxHome",
    description:
      "House rental and sharing solutions without the middleman complexity.",
  ...
  },
  {
    ...
    name: "VxFlight",
    description:
      "From your home straight to the airport - we handle all the logistics.",
...
const ServicesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 transition-colors duration-300 dark:bg-gray-900">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-white pb-16 pt-[120px] dark:bg-gray-900 md:pb-20 md:pt-[150px] lg:pb-28 lg:pt-[180px]">
          ...
          <div className="text-center">
            <div className="mx-auto mb-6 max-w-4xl">
              ...
              <p className="text-lg text-body-color dark:text-gray-300 sm:text-xl lg:text-2xl">
                Discover our comprehensive suite of innovative services designed
            ...
            <div className="mx-auto mb-12 grid max-w-4xl grid-cols-2 gap-4 sm:grid-cols-4 lg:gap-8">
              <div className="rounded-lg bg-primary/5 p-4 dark:bg-primary/10">
                ...
                <div className="text-sm text-body-color dark:text-gray-300">
                  Services
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {featuredServices.map((service, index) => (
                ...
                >
                  {/* Featured Badge */}
                  <div className="from-yellow-400 absolute right-4 top-4 rounded-full bg-gradient-to-r to-orange-500 px-3 py-1 text-xs font-medium text-white">
                    Featured
                  </div>

                  {/* Category Badge */}
                  <div
                    className={`absolute left-4 top-4 rounded-full ${categoryColors[service.category] || "bg-gray-500"} px-3 py-1 text-xs font-medium text-white`}
                  >
                    {service.category}
                  </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {services.map((service, index) => (
              ...
              >
                {/* Category Badge */}
                <div
                  className={`mb-4 inline-block rounded-full ${categoryColors[service.category] || "bg-gray-500"} px-3 py-1 text-xs font-medium text-white`}
                >
                  {service.category}
                </div>
